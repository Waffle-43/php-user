    ...
    <div class="service-card bg-white rounded-xl overflow-hidden shadow-md transition">
        ...
        <div class="p-6">
            ...
            <div class="flex justify-between items-center">
                ...
                <a href="book-appt.php?service_id={$serviceId}" class="bg-primary hover:bg-purple-700 text-white px-4 py-2 rounded-full text-sm transition">
                    Book Now
                </a>
            </div>
        </div>
...
<head>
    ...
    <style>
        ...
        .dropdown-menu {
            ...
            /* This creates the lingering effect */
        }
    </style>
</head>
...
<body>
    ...
    <header class="bg-white shadow-sm sticky top-0 z-50">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-2">
                ...
                <span class="text-xl font-bold text-dark">Heavenly Harmony Spa</span>
            </div>

            <!-- Desktop Navigation - Including all modules -->
            <nav class="hidden md:flex space-x-6">
                <a href="home" class="nav-item active text-primary font-medium py-2">Home</a>
                ...
                <div class="relative group ml-4">
                    ...
                    <div class="absolute left-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50 dropdown-menu">
                        ...
                        <a href="book-appt" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                            <i class="fas fa-calendar-check mr-2 text-primary"></i> Appointment Booking
                        </a>
                        <a href="service-dashboard?stylist_id=1"
                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                ...
                <div class="hidden md:flex items-center space-x-2">
                    ...
                    <div class="relative group">
                        ...
                        <button class="flex items-center space-x-2">
                            <img src="<?= htmlspecialchars($profilePicture) ?>" alt="User" class="w-8 h-8 rounded-full">
                            <span
                                class="text-gray-700 font-medium"><?= htmlspecialchars($user['username']) ?></span>
                        ...
                        <div class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50 dropdown-menu">
                            ...
                            <a href="my-appt" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">My Appointments</a>
                            <a href="logout" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Logout</a>
                        </div>
                    </div>
                </div>
                <a href="#booking"
                    class="hidden md:block bg-primary text-white px-4 py-2 rounded-md hover:bg-purple-700 transition">
        ...
        <div class="mobile-menu bg-white md:hidden" id="mobile-menu">
            <div class="container mx-auto px-4 py-2 flex flex-col space-y-2">
                ...
                <div class="pt-2 border-t border-gray-200">
                    ...
                    <a href="book-appt" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded">
                        <i class="fas fa-calendar-check mr-2 text-primary"></i> Appointment Booking
                    </a>
                    <a href="service_provider_dashboard.php?stylist_id=1"
                        class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded">
                        <i class="fas fa-tachometer-alt mr-2 text-green-500"></i> Service Provider Dashboard
                    </a>
                </div>
                ...
                <div class="pt-2 border-t border-gray-200">
                    <a href="#booking"
                        class="w-full bg-primary text-white px-4 py-2 rounded-md hover:bg-purple-700 transition mb-2 block text-center">
                        <i class="fas fa-calendar-day mr-2"></i> Book Now
                    </a>
                    <?php if ($isLoggedIn): ?>
                        ...
                        <div class="grid grid-cols-1 gap-2 py-2">
                            <a href="profile" class="text-gray-600 hover:text-primary text-sm"><i
                                    class="fas fa-user mr-2"></i> My Profile</a>
                            <a href="my-appt" class="text-gray-600 hover:text-primary text-sm"><i
                                    class="fas fa-calendar-check mr-2"></i> My Appointments</a>
                            <a href="logout" class="text-gray-600 hover:text-primary text-sm"><i
                    ...
                    <?php else: ?>
                        ...
                        <div class="grid grid-cols-2 gap-2 py-2">
                            <a href="sign-in" class="text-gray-600 hover:text-primary text-sm"><i
                                    class="fas fa-user mr-2"></i> Login</a>
                            <a href="sign-up" class="text-gray-600 hover:text-primary text-sm"><i
    ...
    <section class="hero-section text-white py-20 md:py-32">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl md:text-2xl mb-8 max-w-2xl mx-auto">Premium salon & spa services tailored just for you.
                Book instantly online.</p>
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="#booking"
                    class="bg-primary hover:bg-purple-700 text-white font-bold py-3 px-8 rounded-full transition">
                    Book Now <i class="fas fa-arrow-right ml-2"></i>
                </a>
                <a href="#services"
                    class="bg-white hover:bg-gray-100 text-primary font-bold py-3 px-8 rounded-full transition">
                    Explore Services
                </a>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="text-center mt-10">
                <a href="Module2-20250505T195816Z-1-001/Module2/SerCus.php"
                    class="inline-block border-2 border-primary text-primary hover:bg-primary hover:text-white font-bold py-3 px-8 rounded-full transition">
                    Browse All Services
                </a>
            </div>
        </div>
    ...
    <section id="stylists" class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto">Our team of certified professionals are ready to help you
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <?php if (isset($stylists) && !empty($stylists)): ?>
                    <?php foreach ($stylists as $stylist): ?>
                        ...
                        <!-- Stylist Card -->
                        <div
                            class="stylist-card bg-light rounded-xl overflow-hidden shadow-md text-center transition hover:shadow-lg">
                            <div class="relative h-64 overflow-hidden">
                                <img src="<?= $stylistImage ?>" alt="<?= $stylistName ?>" class="w-full h-full object-cover">
                            </div>
                            <div class="p-6">
                                ...
                                <a href="book-appt?stylist_id=<?= $stylistId ?>"
                                    class="bg-primary hover:bg-purple-700 text-white px-4 py-2 rounded-full text-sm transition w-full inline-block">
                ...
                <?php else: ?>
                    ...
                    <div
                        class="stylist-card bg-light rounded-xl overflow-hidden shadow-md text-center transition hover:shadow-lg">
                        <div class="relative h-64 overflow-hidden">
                            <img src="https://randomuser.me/api/portraits/women/32.jpg" alt="Emma Wilson"
                    ...
                    <div
                        class="stylist-card bg-light rounded-xl overflow-hidden shadow-md text-center transition hover:shadow-lg">
                        <div class="relative h-64 overflow-hidden">
                            <img src="https://randomuser.me/api/portraits/women/44.jpg" alt="Sophia Chen"
                                class="w-full h-full object-cover">
                        </div>
                        <div class="p-6">
                    ...
                    <div
                        class="stylist-card bg-light rounded-xl overflow-hidden shadow-md text-center transition hover:shadow-lg">
                        <div class="relative h-64 overflow-hidden">
                            <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="David Rodriguez"
                                class="w-full h-full object-cover">
                        </div>
                        <div class="p-6">
                    ...
                    <div
                        class="stylist-card bg-light rounded-xl overflow-hidden shadow-md text-center transition hover:shadow-lg">
                        <div class="relative h-64 overflow-hidden">
                            <img src="https://randomuser.me/api/portraits/women/68.jpg" alt="Mia Johnson"
                                class="w-full h-full object-cover">
                        </div>
                        <div class="p-6">
            ...
            <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="md:flex">
                    <div class="md:w-1/2 bg-primary text-white p-8 md:p-12">
                        ...
                        <p class="mb-6">Book your appointment in just a few clicks. Our flexible scheduling makes it
                            easy to find the perfect time.</p>
                    ...
                    <div class="md:w-1/2 p-8 md:p-12">
                        ...
                        <form action="book-appt" method="get">
                            <div class="mb-4">
                                <label class="block text-gray-700 text-sm font-bold mb-2" for="service">Select
                                    Service</label>
                                <select id="service" name="service_id"
                                    class="w-full px-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
                                    <option value="">Select a Service</option>
                                    <?php if (isset($allServices) && !empty($allServices)): ?>
                                        <?php foreach ($allServices as $service): ?>
                                            <option value="<?= $service['id'] ?>"><?= htmlspecialchars($service['name']) ?> (RM
                            ...
                            <div class="mb-4">
                                <label class="block text-gray-700 text-sm font-bold mb-2" for="stylist">Preferred
                                    Stylist</label>
                                <select id="stylist" name="stylist_id"
                                    class="w-full px-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
                                    <option value="">Any Available Stylist</option>
                                    <?php if (isset($stylists) && !empty($stylists)): ?>
                                        <?php foreach ($stylists as $stylist): ?>
                                            <option value="<?= $stylist['id'] ?>"><?= htmlspecialchars($stylist['name']) ?>
                                                (<?= htmlspecialchars($stylist['specialization']) ?>)</option>
                                        <?php endforeach; ?>
                                    <?php else: ?>
                            ...
                            <div class="mb-4">
                                <label class="block text-gray-700 text-sm font-bold mb-2" for="date">Preferred
                                    Date</label>
                            ...
                            <button type="submit"
                                class="w-full bg-primary hover:bg-purple-700 text-white font-bold py-3 px-4 rounded-lg transition">
                                Continue to Booking
                            </button>
                        </form>

                        <div class="mt-6 text-center">
                            <p class="text-gray-600 text-sm">Need help? Call us at <a href="tel:+60123456789"
                                    class="text-primary font-medium">(60) 123-456-789</a></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-16 bg-primary text-white">
        <div class="container mx-auto px-4 text-center">
            <h2 class="text-3xl md:text-4xl font-bold mb-4">Ready to Experience Harmon Heavon?</h2>
            <p class="text-xl mb-8 max-w-2xl mx-auto">Join thousands of satisfied clients who trust us with their beauty
                needs.</p>
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="book-appt"
                    class="bg-white hover:bg-gray-100 text-primary font-bold py-3 px-8 rounded-full transition">
                ...
                <a href="tel:+60123456789"
                    class="border-2 border-white hover:bg-white hover:bg-opacity-10 font-bold py-3 px-8 rounded-full transition">
    ...
    <footer class="bg-dark text-white py-12">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <div class="flex items-center space-x-2 mb-4">
                        <i class="fas fa-spa text-primary text-2xl"></i>
                        <span class="text-xl font-bold">Harmony Heaven</span>
                    </div>
                    <p class="text-gray-400 mb-4">Your premier destination for salon and spa services, offering luxury
                        treatments with convenience.</p>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li>
                            <a href="book-appt" class="text-gray-400 hover:text-white">
                                <i class="fas fa-calendar-check mr-2 text-primary"></i> Appointment Booking
                            </a>
                        </li>
                        <li>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li class="flex items-center">
                            ...
                            <a href="mailto:hello@glamourhaven.com"
                                class="text-gray-400 hover:text-white">hello@harmonyheaven.com</a>
                        </li>
                        <li class="flex items-center">
            ...
            <div class="border-t border-gray-800 mt-10 pt-8 flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-400 text-sm mb-4 md:mb-0">© <?= date('Y') ?> Harmony Heaven. All rights reserved.
                </p>
